...
const ElementoRifaAnterior: React.FC<ElementoRifaProps> = ({ rifa, esAsociacion }) => { //Pa que lo que se pase siga de tipo evento
    ...
    //DISENY
    return (
        <TouchableWithoutFeedback onPressIn={handlePressIn} onPressOut={handlePressOut} onPress={()=>router.navigate({pathname: esAsociacion?`/RifasAsociacion/ResultadoRifa`:`/RifasUsuario/ResultadoRifa`, params:{id:rifa?.id}}as any)} >
