...
const ElementoRifaAsociacion: React.FC<ElementoRifaProps> = ({ rifa }) => { //Pa que lo que se pase siga de tipo evento
    ...
    //DISENY
    return (
        <Pressable onPress={()=>router.navigate({pathname:`/RifasAsociacion/[id]`, params:{id:rifa?.id}}as any)} style={[styles.contenedorElemento, { backgroundColor: color.colorFondo, shadowColor: color.colorFondo, shadowOffset: { width: 0, height: 6 }, shadowRadius: 8, shadowOpacity: 0.525, elevation: 2 }]}>
...
export default ElementoRifaAsociacion;
