...
const ElementoRifaAsociacion: React.FC<ElementoRifaProps> = ({ rifa }) => { //Pa que lo que se pase siga de tipo evento
    ...
    //DISENY
    return (
        <TouchableWithoutFeedback onPressIn={handlePressIn} onPressOut={handlePressOut} onPress={()=>router.navigate({pathname:`/RifasAsociacion/[id]`, params:{id:rifa?.id}}as any)}>
